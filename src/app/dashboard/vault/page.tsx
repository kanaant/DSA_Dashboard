          ...
          <header className="relative z-30 rounded-2xl border border-white/10 bg-slate-950/45 p-6 backdrop-blur-2xl shadow-[0_20px_50px_rgba(2,6,23,0.7),inset_0_1px_0_rgba(255,255,255,0.08)] select-none">
            <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
              <div className="space-y-3">
                <div className="inline-flex items-center gap-2 rounded-full border border-[#00d4ff]/35 bg-[#00d4ff]/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-[#00d4ff] shadow-[0_0_20px_rgba(0,212,255,0.15)] backdrop-blur-md">
                  <Archive className="h-4 w-4 animate-pulse text-[#00d4ff]" />
